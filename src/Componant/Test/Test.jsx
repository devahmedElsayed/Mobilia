    ...
    const Test = () => {
      return (
        <div className='test'>
               <Carousel  style={{height:'60vh ' , backgroundColor:'#eee', paddingTop:'50px', height:'auto',marginTop:'50px'}}>
         <Carousel.Item style={{ lineHeight:'30px',position: 'relative', textAlign: 'center', backgroundColor:'#eee', paddingTop:'50px',}} >
                    ...
                    <h2  className=' m-auto'>Maria Jones</h2>
      ...
      <Carousel.Item style={{ lineHeight:'30px',position: 'relative', textAlign: 'center', backgroundColor:'#eee', paddingTop:'50px' }}>
                    ...
                    <h2  className=' m-auto'>jakpo james</h2>
                    <p style={{ marginBottom:' 50px ' }}>CEO, Co-Founder, XYZ Inc.</p>
      </Carousel.Item>
      <Carousel.Item style={{ lineHeight:'30px',position: 'relative', textAlign: 'center' , backgroundColor:'#eee', paddingTop:'50px'}}>
                    <h2>Testimonials</h2>
                    ...
                    <h2  className=' m-auto'>giana Johny</h2>
                    <p style={{ marginBottom:' 50px ' }}>CEO, Co-Founder, XYZ Inc.</p>
      </Carousel.Item>
